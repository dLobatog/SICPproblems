;The procedure accumulate-n is similar to accumu-
;late except that it takes as its third argument a sequence of
...
;value of (accumulate-n + 0 s) should be the sequence (22 26 30).
