...
;
;By separating what can be accomplished with square into 2 different procedures,
;Louis is effectively creating a recursion tree with his calls to expmod.
;Using square is just one call and therefore it will be a linear recursion,
;not a tree.
