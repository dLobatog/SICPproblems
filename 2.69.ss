...
; If you find yourself designing a complex procedure, then you are almost certainly
; doing something wrong. You can take significant advantage of the fact that we are
; using an ordered set representation.)

(define (successive-merge leaf-set)
  (if (= (length leaf-set) 1)
    leaf-set
    (successive-merge (make-code-tree (smallest-weight leaf-set))
