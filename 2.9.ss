...
; between its upper and lower bounds. The width is a measure of
; the uncertainty of the number specified by the interval. For some
...
; whereas for others the width of the combination is not a function
; of the widths of the argument intervals. Show that the width of
