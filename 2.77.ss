...
; to Alyssa P. Hacker, who says “The problem is that the complex-
; number selectors were never defined for complex numbers, just
...
; This procedure magnitude is a generic selector
...
;
; (magnitude (3 4))
; ; This procedure magnitude is a procedure
; ; in the rectangular package of the complex-number system
;
; Therefore, apply-generic is called twice, one for complex, another one for rectangular
